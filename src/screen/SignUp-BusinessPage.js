...
import { View, Text, Button, StyleSheet, ScrollView, Image, TextInput, TouchableOpacity, SafeAreaView, StatusBar } from 'react-native';
        ...
        <ScrollView keyboardShouldPersistTaps='handled'
          ...
          <View>
            ...
            <View style={styles.container}>
              <TouchableOpacity
                onPress={() => { this.props.navigation.navigate('LoginBusiness') }}
